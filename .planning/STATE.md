...
**Current focus:** Phase 7 (Release Pipeline on pnpm + Turborepo) pipeline ready — actual publish + tag operator-gated.
...
Then Phase 8 — `/gsd-plan-phase 8` (StackMap migration).
